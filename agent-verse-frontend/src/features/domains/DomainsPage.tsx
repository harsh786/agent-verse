...
const DOMAINS = [
  ...
  { key: 'legal', name: 'Legal', icon: '⚖️', tagline: 'Contract review at paralegal speed', color: 'bg-[#0F1826] dark:bg-slate-900/20' },
  ...
  { key: 'cybersecurity', name: 'Cybersecurity', icon: '🔒', tagline: 'SIEM triage without analyst fatigue', color: 'bg-[#0F1826] dark:bg-gray-900/20' },
  ...
  { key: 'automobile', name: 'Automobile & EV', icon: '🚗', tagline: 'RC transfer to service reminders', color: 'bg-[#0F1826] dark:bg-slate-900/20' },
