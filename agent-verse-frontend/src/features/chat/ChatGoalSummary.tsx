      ...
      {suggestions.length > 0 && (
        <div className="flex flex-wrap gap-2">
          {suggestions.map((s, i) => (
            <button
              key={i}
              className="text-xs px-3 py-1 bg-card border border-border rounded-full text-muted-foreground/70 hover:border-indigo-400 hover:text-indigo-600 transition-colors"
