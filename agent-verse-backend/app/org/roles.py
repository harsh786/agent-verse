...
def _add(
    ...
    ROLE_TAXONOMY[role_id] = RoleDefinition(
        ...
        allowed_tools=tools or _MGMT_TOOLS,
        primary_model=model,
        budget_usd_per_task=budget,
...
for _name in [
    ...
    _add(
        ...
        "strategy",
        "senior",
        ["web_search", "data_analysis", "financial_modeling"],
        _RESEARCH_TOOLS + _ANALYSIS_TOOLS,
        "smart",
        1.5,
    )
...
for _name in [
    ...
    _add(
        ...
        "product",
        "senior",
        ["web_search", "data_analysis", "content_writing"],
        _RESEARCH_TOOLS,
        "smart",
        1.0,
    )
...
for _name in [
    ...
    _add(
        ...
        "ai_ml",
        "senior",
        ["code_generation", "data_analysis", "rpa_automation"],
        _CODE_TOOLS + _ANALYSIS_TOOLS,
        "coding",
        2.5,
    )
...
for _name in [
    ...
    _add(
        ...
        "marketing",
        "mid",
        ["content_writing", "web_search", "data_analysis"],
        _CONTENT_TOOLS + _ANALYSIS_TOOLS,
        "creative",
        1.0,
    )
...
for _name in [
    ...
    _add(
        ...
        "finance",
        "senior",
        ["financial_modeling", "data_analysis", "sql"],
        _ANALYSIS_TOOLS,
        "analytical",
        2.0,
        3,
...
for _name in [
    ...
    _add(
        ...
        "hr",
        "mid",
        ["web_search", "content_writing", "data_analysis"],
        _CONTENT_TOOLS,
        "smart",
        0.8,
    )
...
for _name in [
    ...
    _add(
        ...
        "devops",
        "senior",
        ["code_generation", "rpa_automation"],
        _CODE_TOOLS,
        "coding",
        2.0,
    )
...
for _name in [
    ...
    _add(
        ...
        "design",
        "senior",
        ["content_writing", "image_generation"],
        _CONTENT_TOOLS,
        "creative",
        1.5,
    )
...
for _name in [
    ...
    _add(
        ...
        "legal",
        "senior",
        ["web_search", "content_writing", "legal_review"],
        _RESEARCH_TOOLS + _CONTENT_TOOLS,
        "expert",
        3.0,
        2,
        "high",
...
for _name in [
    ...
    _add(
        ...
        "senior",
        ["web_search", "content_writing"],
        _CONTENT_TOOLS + _RESEARCH_TOOLS,
        "smart",
        1.0,
    )
