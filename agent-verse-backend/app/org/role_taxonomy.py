...
FULL_ROLE_TAXONOMY: dict[str, list[FullRoleDefinition]] = {
    # ── DEPT 1: EXECUTIVE ────────────────────────────────────────────────────
    "executive": [
        FullRoleDefinition("CEO", "executive", "executive",
                           capabilities=["strategic_planning", "decision_making", "org_management"],
                           model_profile="premium", cost_category="executive",
                           autonomy_level=5, quality_threshold=0.97),
        FullRoleDefinition("CTO", "executive", "executive",
                           capabilities=["technology_strategy", "engineering_oversight"],
                           model_profile="premium", cost_category="executive"),
        FullRoleDefinition("CFO", "executive", "executive",
                           capabilities=["financial_modeling", "budget_planning", "risk_analysis"],
                           model_profile="premium", cost_category="executive",
                           requires_approval_for=["spend_gt_50k"]),
        FullRoleDefinition("CMO", "executive", "executive",
                           capabilities=["marketing_strategy", "brand_management"],
                           model_profile="premium", cost_category="executive"),
        FullRoleDefinition("Chief AI Officer", "executive", "executive",
                           capabilities=["ai_strategy", "model_governance"],
                           model_profile="premium", cost_category="executive"),
    ],
    # ── DEPT 2: STRATEGY & BUSINESS ──────────────────────────────────────────
    "strategy_business": [
        FullRoleDefinition("Business Strategist", "strategy_business", "senior",
                           capabilities=["strategic_planning", "competitive_intelligence", "market_analysis"],
                           model_profile="smart"),
        FullRoleDefinition("Market Analyst", "strategy_business", "mid",
                           capabilities=["market_analysis", "web_search", "data_analysis"],
                           model_profile="smart"),
        FullRoleDefinition("Competitive Intelligence Agent", "strategy_business", "mid",
                           capabilities=["competitive_intelligence", "web_search"],
                           model_profile="research"),
        FullRoleDefinition("Business Development Agent", "strategy_business", "senior",
                           capabilities=["partnership_management", "opportunity_analysis"],
                           model_profile="smart"),
        FullRoleDefinition("Growth Strategist", "strategy_business", "senior",
                           capabilities=["growth_hacking", "funnel_optimization"],
                           model_profile="analytical"),
    ],
    # ── DEPT 3: PRODUCT ──────────────────────────────────────────────────────
    "product": [
        FullRoleDefinition("Product Manager", "product", "senior",
                           capabilities=["product_strategy", "roadmap_management", "user_research"],
                           model_profile="smart"),
        FullRoleDefinition("Product Owner", "product", "mid",
                           capabilities=["backlog_management", "sprint_planning"],
                           model_profile="smart"),
        FullRoleDefinition("User Researcher", "product", "mid",
                           capabilities=["user_research", "survey_design", "data_analysis"],
                           model_profile="smart"),
    ],
    # ── DEPT 4: ENGINEERING ──────────────────────────────────────────────────
    "engineering": [
        FullRoleDefinition("Software Architect", "engineering", "principal",
                           capabilities=["architecture_design", "code_review", "database_design"],
                           model_profile="coding", quality_threshold=0.95),
        FullRoleDefinition("Backend Engineer", "engineering", "senior",
                           capabilities=["code_generation", "database_design", "api_design"],
                           model_profile="coding"),
        FullRoleDefinition("Frontend Engineer", "engineering", "senior",
                           capabilities=["frontend_development", "ui_design", "accessibility"],
                           model_profile="coding"),
        FullRoleDefinition("Platform Engineer", "engineering", "senior",
                           capabilities=["infrastructure_management", "cicd", "kubernetes"],
                           model_profile="coding"),
        FullRoleDefinition("SDK Engineer", "engineering", "senior",
                           capabilities=["code_generation", "api_design", "documentation_writing"],
                           model_profile="coding"),
    ],
    # ── DEPT 5: AI/ML ────────────────────────────────────────────────────────
    "ai_ml": [
        FullRoleDefinition("AI Architect", "ai_ml", "principal",
                           capabilities=["ai_strategy", "model_governance", "architecture_design"],
                           model_profile="expert", quality_threshold=0.97),
        FullRoleDefinition("LLM Engineer", "ai_ml", "senior",
                           capabilities=["fine_tuning", "prompt_engineering", "model_evaluation"],
                           model_profile="coding"),
        FullRoleDefinition("RAG Engineer", "ai_ml", "senior",
                           capabilities=["knowledge_synthesis", "vector_search", "data_ingestion"],
                           model_profile="coding"),
        FullRoleDefinition("AI Safety Engineer", "ai_ml", "senior",
                           capabilities=["security_audit", "guardrails_design"],
                           model_profile="expert", quality_threshold=0.99),
    ],
    # ── DEPT 6: MARKETING ────────────────────────────────────────────────────
    "marketing": [
        FullRoleDefinition("Content Strategist", "marketing", "senior",
                           capabilities=["content_strategy", "seo_optimization"],
                           model_profile="creative"),
        FullRoleDefinition("Copywriter", "marketing", "mid",
                           capabilities=["copywriting", "content_writing"],
                           model_profile="creative"),
        FullRoleDefinition("SEO Strategist", "marketing", "mid",
                           capabilities=["seo_optimization", "keyword_research"],
                           model_profile="analytical"),
        FullRoleDefinition("Growth Marketer", "marketing", "senior",
                           capabilities=["growth_hacking", "conversion_optimization"],
                           model_profile="analytical"),
        FullRoleDefinition("Performance Marketing Agent", "marketing", "mid",
                           capabilities=["paid_advertising", "campaign_management"],
                           model_profile="analytical"),
        FullRoleDefinition("PR Manager", "marketing", "senior",
    ...
    # ── DEPT 19: QA/QUALITY ──────────────────────────────────────────────────
    "qa": [
        FullRoleDefinition("QA Architect", "qa", "principal",
                           capabilities=["test_design", "quality_assurance"],
                           model_profile="analytical"),
        FullRoleDefinition("LLM Evaluator", "qa", "senior",
                           capabilities=["llm_evaluation", "hallucination_detection"],
                           model_profile="analytical"),
        FullRoleDefinition("Chaos Engineer", "qa", "senior",
                           capabilities=["chaos_testing", "reliability_testing"],
                           model_profile="coding"),
    ],
    # ── DEPT 20: PROCUREMENT ─────────────────────────────────────────────────
    "procurement": [
        FullRoleDefinition("Vendor Research Agent", "procurement", "mid",
                           capabilities=["vendor_research", "web_search"],
                           model_profile="smart"),
        FullRoleDefinition("Negotiation Support Agent", "procurement", "senior",
    ...
    # ── DEPT 21: PMO ─────────────────────────────────────────────────────────
    "pmo": [
        FullRoleDefinition("Program Manager", "pmo", "senior",
                           capabilities=["project_planning", "dependency_management"],
                           model_profile="smart"),
        FullRoleDefinition("Scrum Master", "pmo", "mid",
                           capabilities=["agile_coaching", "sprint_planning"],
                           model_profile="smart"),
    ],
    # ── DEPT 22: KNOWLEDGE MANAGEMENT ───────────────────────────────────────
    "knowledge_management": [
        FullRoleDefinition("Knowledge Engineer", "knowledge_management", "senior",
                           capabilities=["knowledge_synthesis", "ontology_design"],
                           model_profile="smart"),
        FullRoleDefinition("Knowledge Curator", "knowledge_management", "mid",
