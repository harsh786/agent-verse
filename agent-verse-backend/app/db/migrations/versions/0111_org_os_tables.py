...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "parent_dept_id", UUID(as_uuid=True), sa.ForeignKey("org_departments.id"), nullable=True
        ),
        sa.Column("name", sa.String(200), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "dept_id", UUID(as_uuid=True), sa.ForeignKey("org_departments.id"), nullable=True
        ),
        sa.Column("name", sa.String(200), nullable=False),
        sa.Column("purpose", sa.Text, server_default=""),
    ...
    op.execute(
        "CREATE INDEX IF NOT EXISTS idx_org_teams_tenant_org    ON org_teams(tenant_id, org_id)"
    )
    op.execute(
        "CREATE INDEX IF NOT EXISTS idx_org_teams_tenant_status ON org_teams(tenant_id, status)"
    )
    ...
    op.execute(
        "CREATE INDEX IF NOT EXISTS idx_org_roles_tenant_org ON org_roles(tenant_id, org_id)"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "assigned_team_id", UUID(as_uuid=True), sa.ForeignKey("org_teams.id"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "mission_id",
            UUID(as_uuid=True),
            sa.ForeignKey("org_missions.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "assigned_team_id", UUID(as_uuid=True), sa.ForeignKey("org_teams.id"), nullable=True
    ...
    op.create_table(
        ...
        sa.Column(
            "workstream_id", UUID(as_uuid=True), sa.ForeignKey("org_workstreams.id"), nullable=True
        ),
        sa.Column(
            "parent_task_id", UUID(as_uuid=True), sa.ForeignKey("org_tasks.id"), nullable=True
        ),
        sa.Column(
            "assigned_team_id", UUID(as_uuid=True), sa.ForeignKey("org_teams.id"), nullable=True
        ),
