...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("action_summary", sa.Text, nullable=False, server_default=sa.text("''")),
        sa.Column("outcome", sa.String(50), nullable=False, server_default=sa.text("'success'")),
        sa.Column("lessons", sa.Text, nullable=False, server_default=sa.text("''")),
    ...
    op.create_table(
        ...
        sa.Column(
            "domain", sa.String(50), nullable=False, server_default=sa.text("'general'"), index=True
        ),
        sa.Column(
            "tool_sequence", postgresql.JSONB, nullable=False, server_default=sa.text("'[]'")
        ),
