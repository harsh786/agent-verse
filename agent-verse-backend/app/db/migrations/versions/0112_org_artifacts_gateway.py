...
def upgrade() -> None:
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_org_artifacts_tenant ON org_artifacts(tenant_id)")
    op.execute(
        "CREATE INDEX IF NOT EXISTS idx_org_artifacts_org ON org_artifacts(tenant_id, org_id)"
    )
    op.execute(
    ...
    op.execute(
        "CREATE INDEX IF NOT EXISTS idx_org_artifacts_status ON org_artifacts(tenant_id, status)"
    )
    op.execute(
        "CREATE INDEX IF NOT EXISTS idx_org_artifacts_kind ON org_artifacts(tenant_id, kind)"
    )
    op.execute(
