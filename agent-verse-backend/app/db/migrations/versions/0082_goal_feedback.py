...
def upgrade() -> None:
    ...
    op.execute(
        "CREATE POLICY tenant_isolation ON goal_feedback USING (tenant_id = current_setting('app.tenant_id', TRUE)) WITH CHECK (tenant_id = current_setting('app.tenant_id', TRUE))"  # noqa: E501
    )
