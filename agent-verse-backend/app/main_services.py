...
async def init_core_services(app_state: Any, settings: Any, db_factory: Any, redis: Any) -> None:
...
def get_service_health(app_state: Any) -> dict[str, str]:
    ...
    services = {
        ...
        "tenant_service": "ok" if getattr(app_state, "tenant_service", None) else "missing",
