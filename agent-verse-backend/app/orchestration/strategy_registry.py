    ...
    *,
    ...
    entries: list[StrategyCapability] = [
        ...
        StrategyCapability(
            ...
            A,
            IMPL,
            "app.agent.patterns.voyager:VoyagerAdapter",
        ...
        StrategyCapability(
            RAGStrategy.MEMORY_AUGMENTED.value,
            R,
            PART,
            "app.rag.contracts:MemoryAugmentedRAGRuntimeAdapter",
            "Cross-session long-term-memory fused with persisted retrieval",
            [],
            [],
            "low",
            "interactive",
        ...
        StrategyCapability(
            RAGStrategy.CODE.value,
            R,
            PART,
            "app.rag.contracts:CodeRAGRuntimeAdapter",
            "Identifier/symbol-boosted retrieval for code questions",
            [],
            [],
            "low",
            "interactive",
