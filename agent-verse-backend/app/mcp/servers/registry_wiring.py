...
def get_builtin_server_configs() -> list[dict]:
    ...
    raw_configs = [
        ...
        # ── New unified / alias servers ───────────────────────────────────────────
        {
            "server_id": "builtin-aws",
            "name": "AWS",
            "description": "AWS MCP server — S3, Lambda, CloudWatch, EC2, IAM",
            "tool_definitions": aws_server.TOOL_DEFINITIONS,
            "handler": aws_server.call_tool,
            "requires_env": ["AWS_ACCESS_KEY_ID", "AWS_SECRET_ACCESS_KEY"],
        },
        {
            "server_id": "builtin-gcp",
            "name": "GCP",
            "description": "GCP MCP server — Cloud Storage, Compute, BigQuery, Pub/Sub",
            "tool_definitions": gcp_server.TOOL_DEFINITIONS,
            "handler": gcp_server.call_tool,
            "requires_env": ["GCP_PROJECT_ID"],
        },
        {
            "server_id": "builtin-postgresql",
            "name": "PostgreSQL",
            "description": "PostgreSQL MCP server — SQL queries and schema inspection",
            "tool_definitions": postgres_server.TOOL_DEFINITIONS,
            "handler": postgres_server.call_tool,
            "requires_env": ["POSTGRES_MCP_URL"],
        },
        {
            "server_id": "builtin-teams",
            "name": "Microsoft Teams",
            "description": "Microsoft Teams MCP server — messages, channels, and meetings",
            "tool_definitions": microsoft_teams_server.TOOL_DEFINITIONS,
            "handler": microsoft_teams_server.call_tool,
            "requires_env": ["TEAMS_ACCESS_TOKEN"],
        },
        {
            "server_id": "builtin-circleci",
            "name": "CircleCI",
            "description": "CircleCI MCP server — pipelines, workflows, and jobs",
            "tool_definitions": circleci_server.TOOL_DEFINITIONS,
            "handler": circleci_server.call_tool,
            "requires_env": ["CIRCLECI_TOKEN"],
        },
        {
            "server_id": "builtin-datadog",
            "name": "Datadog",
            "description": "Datadog MCP server — monitors, metrics, dashboards, and logs",
            "tool_definitions": datadog_server.TOOL_DEFINITIONS,
            "handler": datadog_server.call_tool,
            "requires_env": ["DATADOG_API_KEY", "DATADOG_APP_KEY"],
        },
        {
            "server_id": "builtin-okta",
            "name": "Okta",
            "description": "Okta MCP server — users, groups, and application management",
            "tool_definitions": okta_server.TOOL_DEFINITIONS,
            "handler": okta_server.call_tool,
            "requires_env": ["OKTA_BASE_URL", "OKTA_API_TOKEN"],
        },
        {
            "server_id": "builtin-pagerduty",
            "name": "PagerDuty",
            "description": "PagerDuty MCP server — incidents, on-call schedules, and escalations",
        ...
        },
        {
            ...
            "name": "Terraform",
            "description": "Terraform Cloud MCP server — workspaces, runs, and variables",
            "tool_definitions": terraform_server.TOOL_DEFINITIONS,
            "handler": terraform_server.call_tool,
            "requires_env": ["TERRAFORM_TOKEN"],
        },
    ]
